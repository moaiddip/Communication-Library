 ...
 * @author Sozos Assias
 */
public class OLDArdConnector extends Thread {
     ...
     * on my pc)
     */
    public OLDArdConnector(String port) {
        this.port = port;
    }
            ...
            while (!quit.get()) {
                ...
                while (portEnum.hasMoreElements()) {
                    ...
                    if (currPortId.getName().equals(port)) {
                        if(problem){                            
                            //obj.initialize(this, ac, currPortId); THIS LINE SHOULDN'T BE COMMENTED. JUST DID IT FOR TESTING
                            this.sleep(2000);
                        }
                        problem=false;
                        break;
