...
Version Revisions:
-------------------
Version 1.0: Made the server automatically detect when an arduino is disconnected and look for it. Cleaned up the code, adjusted the synchronized methods.
